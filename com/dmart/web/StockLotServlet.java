...
public class StockLotServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        try (Connection conn = DBConnection.getConnection()) {
            ...
            List<StockLot> lots = stockLotDao.findPage(conn, itemId, zoneId, warehouseId, status, allowedWarehouseIds, pg.offset, pg.size);
            int total = stockLotDao.count(conn, itemId, zoneId, warehouseId, status, allowedWarehouseIds);
